...
public class MiscItineraryTest extends TestBase {
	...
	public void beforeClass(String excelPath) {
		...
		reportLogger = report.startTest("MiscItineraryPageTest Script");
	...
	public void miscItineraryPageTest(String active, String environment, String createOrModify, String segmentNumber, String tourOperator, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber, String finalResult, String dataRow) {
		System.out.println("@Test - miscItineraryPageTest()");
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			if (createOrModify.equalsIgnoreCase("create")) {
				...
				clientFilePage.navigateToNewItineraryPage("Misc");
				
				//Enter the necessary itinerary info
				miscItineraryPage.enterMiscItineraryInfo(tourOperator, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Select the first Traveler
				miscItineraryPage.selectTraveler();
				
				//Click 'Save' to create the itinerary
				miscItineraryPage.clickSaveButton();
				
			} else if (createOrModify.equalsIgnoreCase("modify")) {
				//Navigate to the itinerary page
				clientFilePage.navigateToItineraryPage(environment, "Misc", segmentNumber);
				
				//Enter the necessary itinerary info
				miscItineraryPage.enterMiscItineraryInfo(tourOperator, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Click 'Save' to create the itinerary
				miscItineraryPage.clickUpdateButton();
			}
			...
			foundItinerary = clientFilePage.navigateToItineraryPage(environment, "Misc", segmentNumber);
			
			//Check if the Itinerary info is correct
			if (foundItinerary) {
				checkpoint = miscItineraryPage.verifyMiscItineraryDetails(checkpoint, tourOperator, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
			} else {
			...
			miscItineraryPage.clickCancelButton();
