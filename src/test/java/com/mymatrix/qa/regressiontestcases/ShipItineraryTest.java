...
public class ShipItineraryTest extends TestBase {
	...
	public void beforeClass(String excelPath) {
		...
		reportLogger = report.startTest("ShipItineraryPageTest Script");
	...
	public void shipItineraryPageTest(String active, String environment, String createOrModify, String segmentNumber, String cruiseLine, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber, String finalResult, String dataRow) {
		System.out.println("@Test - shipItineraryPageTest()");
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			if (createOrModify.equalsIgnoreCase("create")) {
				...
				clientFilePage.navigateToNewItineraryPage("Ship");
				
				//Enter the necessary itinerary info
				shipItineraryPage.enterShipItineraryInfo(cruiseLine, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Select the first Traveler
				shipItineraryPage.selectTraveler();
				
				//Click 'Save' to create the itinerary
				shipItineraryPage.clickSaveButton();
				
			} else if (createOrModify.equalsIgnoreCase("modify")) {
				//Navigate to the itinerary page
				clientFilePage.navigateToItineraryPage(environment, "Ship", segmentNumber);
				
				//Enter the necessary itinerary info
				shipItineraryPage.enterShipItineraryInfo(cruiseLine, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Click 'Save' to create the itinerary
				shipItineraryPage.clickUpdateButton();
			}
			...
			foundItinerary = clientFilePage.navigateToItineraryPage(environment, "Ship", segmentNumber);
			
			//Check if the Itinerary info is correct
			if (foundItinerary) {
				checkpoint = shipItineraryPage.verifyShipItineraryDetails(checkpoint, cruiseLine, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
			} else {
			...
			shipItineraryPage.clickCancelButton();
