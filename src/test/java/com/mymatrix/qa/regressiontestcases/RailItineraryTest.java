...
public class RailItineraryTest extends TestBase {
	...
	public void beforeClass(String excelPath) {
		...
		reportLogger = report.startTest("RailItineraryPageTest Script");
	...
	public void railItineraryPageTest(String active, String environment, String createOrModify, String segmentNumber, String supplierCode, String trainNumber, String classCode, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber, String finalResult, String dataRow) {
		System.out.println("@Test - railItineraryPageTest()");
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			if (createOrModify.equalsIgnoreCase("create")) {
				...
				clientFilePage.navigateToNewItineraryPage("Rail");
				
				//Enter the necessary itinerary info
				railItineraryPage.enterRailItineraryInfo(supplierCode, trainNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Select the first Traveler
				railItineraryPage.selectTraveler();
				
				//Click 'Save' to create the itinerary
				railItineraryPage.clickSaveButton();
				
			} else if (createOrModify.equalsIgnoreCase("modify")) {
				//Navigate to the itinerary page
				clientFilePage.navigateToItineraryPage(environment, "Rail", segmentNumber);
				
				//Enter the necessary itinerary info
				railItineraryPage.enterRailItineraryInfo(supplierCode, trainNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Click 'Save' to create the itinerary
				railItineraryPage.clickUpdateButton();
			}
			...
			foundItinerary = clientFilePage.navigateToItineraryPage(environment, "Rail", segmentNumber);
			
			//Check if the Itinerary info is correct
			if (foundItinerary) {
				checkpoint = railItineraryPage.verifyRailItineraryDetails(checkpoint, supplierCode, trainNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
			} else {
			...
			railItineraryPage.clickCancelButton();
