...
public class BusItineraryTest extends TestBase {
	...
	public void beforeClass(String excelPath) {
		...
		reportLogger = report.startTest("BusItineraryPageTest Script");
	...
	public void busItineraryPageTest(String active, String environment, String createOrModify, String segmentNumber, String supplierCode, String busNumber, String classCode, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber, String finalResult, String dataRow) {
		System.out.println("@Test - busItineraryPageTest()");
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			if (createOrModify.equalsIgnoreCase("create")) {
				...
				clientFilePage.navigateToNewItineraryPage("Bus");
				
				//Enter the necessary itinerary info
				busItineraryPage.enterBusItineraryInfo(supplierCode, busNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Select the first Traveler
				busItineraryPage.selectTraveler();
				
				//Click 'Save' to create the itinerary
				busItineraryPage.clickSaveButton();
				
			} else if (createOrModify.equalsIgnoreCase("modify")) {
				//Navigate to the itinerary page
				clientFilePage.navigateToItineraryPage(environment, "Bus", segmentNumber);
				
				//Enter the necessary itinerary info
				busItineraryPage.enterBusItineraryInfo(supplierCode, busNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
				
				//Click 'Save' to create the itinerary
				busItineraryPage.clickUpdateButton();
			}
			...
			foundItinerary = clientFilePage.navigateToItineraryPage(environment, "Bus", segmentNumber);
			
			//Check if the Itinerary info is correct
			if (foundItinerary) {
				checkpoint = busItineraryPage.verifyBusItineraryDetails(checkpoint, supplierCode, busNumber, classCode, departureCity, arrivalCity, departureDate, arrivalDate, gdsSegmentNumber);
			} else {
			...
			busItineraryPage.clickCancelButton();
