...
public class RailItineraryLocators {
	...
	protected WebElement supplierCodeField;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_serviceTextBox']")
	protected WebElement trainNumberField;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_classTextBox']")
	protected WebElement classCodeField;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_originTextBox']")
	protected WebElement departureCityField;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_destinTextBox']")
	...
	protected WebElement arrivalDateField;
