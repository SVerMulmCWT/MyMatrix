...
public class NonBSPTicketLocators {
	...
	@FindBy(xpath="//span[@id='ContentPlaceHolder1_nonBSPSupplierLabel']")
	protected WebElement supplierLabel;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_searchSuppliersButton']")
	protected WebElement confirmSupplierButton;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_cancelSupplierSearchButton']")
	protected WebElement cancelSupplierButton;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_ticketNumberTextBox']")
	protected WebElement ticketNumberField;
	
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_bookingNumberTextBox']")
	protected WebElement bookingNumberField;
	...
	@FindBy(xpath="//input[@id='ContentPlaceHolder1_TravellerList2_travellerGridView_travellerCheckBox_0']")
