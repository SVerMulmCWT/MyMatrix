...
import com.mymatrix.qa.pagelocators.BSPTicketLocators;
...
public class BSPTicketPage extends BSPTicketLocators {
	...
	public void enterTicketInfo(String supplierCode, String ticketNumber, String paymentType) {
	...
	public void modifyTicketInfo(String supplierCode, String paymentType, String description, String baseCost, String taxAmount, String taxCode, String cityCode) {
		//Output to the system and report
	...
	public SoftAssert verifyTicketCreation(SoftAssert softAssert, String supplierCode, String paymentType) {
		...
		softAssert.assertEquals(supplierField.getAttribute("value"), supplierCode);
