...
import com.mymatrix.qa.pagelocators.ShipItineraryLocators;
...
public class ShipItineraryPage extends ShipItineraryLocators {
	...
	public void enterShipItineraryInfo(String cruiseLine, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber) {
		//Output to the system and report
		System.out.println("Entering new Ship Itinerary info");
		reportLogger.log(LogStatus.INFO,  "Entering new Ship Itinerary info");
		
		//Enter the Cruise Line Code
		cruiseLineField.clear();
		cruiseLineField.sendKeys(cruiseLine);
	...
	public SoftAssert verifyShipItineraryDetails(SoftAssert softAssert, String cruiseLine, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber) {
		//Output to the system and report
		...
		//Check if the 'Cruise Line' matches expectations
		cruiseLine = genMethods.formatSupplier(cruiseLine);
		String actualTourCode = cruiseLineField.getAttribute("value").substring(cruiseLineField.getAttribute("value").length()-cruiseLine.length());
		softAssert.assertEquals(actualTourCode, cruiseLine);
