...
import com.mymatrix.qa.pagelocators.QueueCountLocators;
import com.relevantcodes.extentreports.ExtentTest;
import com.relevantcodes.extentreports.LogStatus;

public class QueueCountPage extends QueueCountLocators {
	
	public QueueCountPage(EventFiringWebDriver eDriver, ExtentTest reportLogger) {
		super(eDriver, reportLogger);
	}
	
	public void selectQueueType(String environment, String queueType) {
		...
		//Select the status for the RMA Queue Search
		String selectRMAStatus;
		if (environment.equalsIgnoreCase("us prod")) {
			selectRMAStatus = "All";
		} else {
			selectRMAStatus = "ALL";
		}
		...
		if (queueType.equalsIgnoreCase("rmi") || queueType.equalsIgnoreCase("rmi rejected interface records")) {
			...
			statusSelector.selectByVisibleText(selectRMAStatus);
	...
	public int getSearchCount(String environment) {
