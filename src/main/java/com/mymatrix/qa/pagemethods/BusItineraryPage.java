...
import com.mymatrix.qa.pagelocators.BusItineraryLocators;
...
public class BusItineraryPage extends BusItineraryLocators {
	...
	public void enterBusItineraryInfo(String supplierCode, String busNumber, String classCode, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber) {
		//Output to the system and report
		System.out.println("Entering new Bus Itinerary info");
		reportLogger.log(LogStatus.INFO,  "Entering new Bus Itinerary info");
		...
		busNumberField.sendKeys(busNumber);
	...
	public SoftAssert verifyBusItineraryDetails(SoftAssert softAssert, String supplierCode, String busNumber, String classCode, String departureCity, String arrivalCity, String departureDate, String arrivalDate, String gdsSegmentNumber) {
		//Output to the system and report
		System.out.println("Checking if the 'Bus Itinerary' details matches expectations");
		reportLogger.log(LogStatus.INFO,  "Checking if the 'Bus Itinerary' details matches expectations");
		...
		softAssert.assertEquals(busNumberField.getAttribute("value"), busNumber);
